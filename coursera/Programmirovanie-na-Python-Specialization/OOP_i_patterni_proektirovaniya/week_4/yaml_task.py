...
"""
Исходный код (необходимо адаптировать для yaml-файлов)
"""
...
"""
Вам необходимо модифицировать приложенный код так, чтобы два следующих кода были эквивалентны (приводили к 
...
#
# 
# def level_constructor(loader, node):
#     data = loader.construct_scalar(node)
#     if data == 'easy_level':
#         return EasyLevel
#     elif data == 'medium_level':
#         return MediumLevel
#     elif data == 'hard_level':
#         return HardLevel
#
#
# loader = yaml.Loader
# loader.add_constructor('!easylevel', level_constructor)
# level = yaml.load(Levels).get_map()
